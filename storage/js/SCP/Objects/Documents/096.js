...
export class MDocument096 extends MapItem {
    constructor() {
    ...
    GetInventoryItem() {
        return new IDocument096();
    }
}

export class IDocument096 extends InventoryItem {


    constructor() {
        super("/storage/img/objects/documentInv.png");
        this.Name = "SCP 096 Document";
        this.Equipable = false;
        this.Type = "document";
    }

    GetMapItem() {
        let t = new MDocument096();
        t.Rotation = Math.random() * 360;
        return t;
    }

    Use() {
        let t = new Sprite(new Vector2(578,0), new Vector2(764, 1080), -5, 0, "/storage/img/objects/Documents/096.jpg", 1, Color.White);
