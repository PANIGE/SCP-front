...
export class MDocumentNuke extends MapItem {
    constructor() {
    ...
    GetInventoryItem() {
        return new IDocumentNuke();
    }
}

export class IDocumentNuke extends InventoryItem {


    constructor() {
        super("/storage/img/objects/documentInv.png");
        this.Name = "Nuke disposition proposal Document";
        this.Equipable = false;
        this.Type = "document";
    }

    GetMapItem() {
        let t = new MDocumentNuke();
        t.Rotation = Math.random() * 360;
        return t;
    }

    Use() {
        let t = new Sprite(new Vector2(578,0), new Vector2(764, 1080), -5, 0, "/storage/img/objects/Documents/Nuke.jpg", 1, Color.White);
