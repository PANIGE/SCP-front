...
export class MDocumentOBJC extends MapItem {
    constructor() {
    ...
    GetInventoryItem() {
        return new IDocumentOBJC();
    }
}

export class IDocumentOBJC extends InventoryItem {


    constructor() {
        super("/storage/img/objects/documentInv.png");
        this.Name = "Object Classification Document";
        this.Equipable = false;
        this.Type = "document";
    }

    GetMapItem() {
        let t = new MDocumentOBJC();
        t.Rotation = Math.random() * 360;
        return t;
    }

    Use() {
        let t = new Sprite(new Vector2(578,0), new Vector2(764, 1080), -5, 0, "/storage/img/objects/Documents/OBJC.jpg", 1, Color.White);
