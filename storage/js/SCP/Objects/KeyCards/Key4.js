...
export class MKeyCard4 extends MapItem {
    constructor() {
        super("/storage/img/objects/keycards/4map.png");
        this.Size = new Vector2(30,30);
    }

    GetInventoryItem() {
        return new IKeyCard4();
    }
}

export class IKeyCard4 extends InventoryItem {

    Level;

    constructor() {
        super("/storage/img/objects/keycards/4inventory.png");
        this.Name = "Level 4 Key Card";
        this.Level = 4;
        this.Equipable = true;
        this.Type = "keycard";
    }
