...
export class MKeyCard3 extends MapItem {
    constructor() {
        super("/storage/img/objects/keycards/3map.png");
        this.Size = new Vector2(30,30);
    }

    GetInventoryItem() {
        return new IKeyCard3();
    }
}

export class IKeyCard3 extends InventoryItem {

    Level;

    constructor() {
        super("/storage/img/objects/keycards/3inventory.png");
        this.Name = "Level 3 Key Card";
        this.Level = 3;
        this.Equipable = true;
        this.Type = "keycard";
    }
